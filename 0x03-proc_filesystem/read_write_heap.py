...
"""
Module for finding a string in the heap of a running process and replace it
"""
...
def print_error():
    ...
    sys.stdout.write("replace string\n")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("[ERROR] Can't open file " + mps_fname)
        ...
        if list_format[-1][:-1] == "[heap]":
            ...
            if len (address) is not 2:
                ...
                try:
                    ...
                    print("[ERROR] Can't open file " + maps)
                    print("        I/O error({}): {}".format(e.errno, e.strerror))
                    maps.close()
                    sys.exit(1)
